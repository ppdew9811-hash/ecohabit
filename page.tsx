...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // For demo purposes, accept any @students.unnes.ac.id email
      if (email.includes('@students.unnes.ac.id') && password.length >= 6) {
        const userData = {
          id: '1',
          firstName: 'John',
          lastName: 'Doe',
        ...
        alert('Login gagal! Pastikan menggunakan email UNNES (@students.unnes.ac.id) dan password minimal 6 karakter.')
      }
      setIsLoading(false)
    }, 1000)
  }
        ...
        <CardHeader className="space-y-4 text-center">
          ...
          <div>
            ...
            <CardDescription className="text-green-600">
              Masuk ke akun EcoHabit Tracker Anda
            </CardDescription>
          </div>
        </CardHeader>
